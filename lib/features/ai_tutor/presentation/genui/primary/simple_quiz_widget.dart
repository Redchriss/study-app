...
class SimpleQuizWidget extends StatefulWidget {
  final SimpleQuizData data;
  final void Function(bool isCorrect, int selectedIndex) onAnswer;

  const SimpleQuizWidget({required this.data, required this.onAnswer});

  @override
  State<SimpleQuizWidget> createState() => _SimpleQuizWidgetState();
}

class _SimpleQuizWidgetState extends State<SimpleQuizWidget>
