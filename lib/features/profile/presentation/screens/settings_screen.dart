    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _card(context, Icons.description_outlined, 'Terms of Service', '/legal/terms'),
          _card(context, Icons.privacy_tip_outlined, 'Privacy Policy', '/legal/privacy'),
          _card(context, Icons.help_outline, 'FAQ', '/legal/faq'),
          _card(context, Icons.support_agent_outlined, 'Support', '/legal/support'),
        ],
      ),
    );
  }

  Widget _card(BuildContext context, IconData icon, String label, String? route, {Widget? trailing}) {
    return Card(
