              ...
              sliver: SliverList(
                delegate: SliverChildListDelegate([
                  ...
                  GlassCard(
                    child: Column(
                      children: [
                        NavRow(icon: Icons.edit_outlined, label: 'Edit Profile', onTap: () => context.push('/edit-profile')),
                        const SectionDivider(),
                        NavRow(icon: Icons.auto_awesome_outlined, label: 'Plans & Credits', onTap: () => context.push('/upgrade')),
                        const SectionDivider(),
                        NavRow(icon: Icons.emoji_events_outlined, label: 'Leaderboard', onTap: () => context.push('/leaderboard')),
                        const SectionDivider(),
                        NavRow(icon: Icons.history_outlined, label: 'Study History', onTap: () => context.push('/history')),
                      ],
                    ),
                  ...
                  GlassCard(
                    child: Column(
                      children: [
                        NavRow(icon: Icons.upload_file_outlined, label: 'Upload Material', onTap: () => context.push('/upload-material')),
                        const SectionDivider(),
                        NavRow(icon: Icons.folder_special_outlined, label: 'My Uploads', onTap: () => context.push('/my-uploads')),
                        const SectionDivider(),
                        NavRow(icon: Icons.article_outlined, label: 'Past Papers', onTap: () => context.push('/past-papers')),
                        const SectionDivider(),
                        NavRow(icon: Icons.library_books_outlined, label: 'Paper Library', onTap: () => context.push('/paper-library')),
                        const SectionDivider(),
                        NavRow(icon: Icons.bookmark_outline, label: 'Bookmarks', onTap: () => context.push('/bookmarks')),
                      ],
                    ),
                  ...
                  GlassCard(
                    child: Column(
                      children: [
                        NavRow(icon: Icons.child_care_outlined, label: 'Kids Mode', badge: 'Safe', badgeColor: DesignTokens.success, onTap: () => context.push('/kids')),
                        const SectionDivider(),
                        NavRow(icon: Icons.family_restroom_outlined, label: 'Kids Progress', onTap: () => context.push('/kids/progress')),
                      ],
                    ),
                    ...
                    child: Column(
                      children: [
                        ListTile(
                          ...
                          title: Text(themeMode == ThemeMode.dark ? 'Light Mode' : 'Dark Mode', style: const TextStyle(fontWeight: FontWeight.w600, fontSize: 14)),
                  ...
                  GlassCard(
                    child: Column(
                      children: [
                        NavRow(icon: Icons.info_outline, label: 'About Yaza', onTap: () => context.push('/about')),
                        const SectionDivider(),
                        NavRow(icon: Icons.gavel_outlined, label: 'Terms of Service', onTap: () => context.push('/legal/terms')),
                        const SectionDivider(),
                        NavRow(icon: Icons.privacy_tip_outlined, label: 'Privacy Policy', onTap: () => context.push('/legal/privacy')),
                        const SectionDivider(),
                        NavRow(icon: Icons.help_outline_rounded, label: 'FAQ', onTap: () => context.push('/legal/faq')),
                        const SectionDivider(),
                        NavRow(icon: Icons.support_agent_outlined, label: 'Support & Contact', onTap: () => context.push('/legal/support')),
                      ],
                    ),
