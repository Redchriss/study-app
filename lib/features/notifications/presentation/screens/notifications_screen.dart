...
class NotificationsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Query(
      ...
      builder: (result, {fetchMore, refetch}) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: Text('Notifications', style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w800)),
            ...
            ? ListView(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: const Icon(Icons.notifications_none_rounded, size: 64, color: DesignTokens.primary),
                  ),
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (_, i) {
                    ...
                    final String type = n['notificationType'] as String? ?? '';
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: isRead 
                                    ? (dark ? Colors.white.withValues(alpha: 0.05) : Colors.grey.shade100) 
                                ...
                                children: [
                                  Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      color: isRead ? DesignTokens.textSecondary : DesignTokens.textPrimary,
                                      height: 1.3,
                                    ),
                                  ),
                                  ...
                                  Text(
                                    ...
                                    style: TextStyle(
                                      ...
                                      color: isRead ? DesignTokens.textTertiary : color.withValues(alpha: 0.8),
                                    ),
                                  ),
                                ],
                              ),
  ...
  IconData _iconForType(String type) {
    switch (type) {
      ...
      case 'circle_invite': return Icons.group_add_rounded;
      case 'quiz_result': return Icons.quiz_rounded;
      case 'ai_credits': return Icons.auto_awesome_rounded;
  ...
  Color _colorForType(String type) {
    switch (type) {
      case 'reply': return const Color(0xFF389E75); // Green
      case 'upvote': return const Color(0xFFE87E5E); // Orange
      case 'circle_invite': return const Color(0xFF5A6BB2); // Purple/Blue
      case 'quiz_result': return const Color(0xFFE5B300); // Gold
      case 'ai_credits': return const Color(0xFF6B48FF); // Deep Purple
