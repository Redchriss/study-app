            ...
            slivers: [
                  ...
                  title: Column(
                    ...
                    children: [
                      ...
                      if (quizzes.isNotEmpty)
                        Text(
                          '${quizzes.length} quiz${quizzes.length == 1 ? '' : 'zes'} to master',
              ...
              if (result.isLoading && quizzes.isEmpty)
                ...
                SliverFillRemaining(
                    child: ErrorState(
                        message:
                            'Could not load quizzes. Check your connection.',
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(
          ...
          const Text('Master concepts with interactive quizzes',
              style: TextStyle(
                  color: Colors.white,
                  fontSize: 13,
                  fontWeight: FontWeight.w700)),
          const Text('Master each topic',
