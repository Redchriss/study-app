...
void _showCommunityShareDialog(
  ...
  showModalBottomSheet(
    ...
    builder: (ctx) => _QuizCommunityShareSheet(
      quizTitle: quizTitle,
      score: score,
      ref: ref,
    ),
...
class _QuizCommunityShareSheet extends ConsumerStatefulWidget {
  final String quizTitle;
  final String score;
  final WidgetRef ref;
  const _QuizCommunityShareSheet({
  ...
  @override
  ConsumerState<_QuizCommunityShareSheet> createState() =>
      _QuizCommunityShareSheetState();
}

class _QuizCommunityShareSheetState
    extends ConsumerState<_QuizCommunityShareSheet> {
    ...
    try {
      ...
      final result = await client.mutate(MutationOptions(
        ...
        variables: {
          ...
          'body': 'I scored ${widget.score}% on ${widget.quizTitle}! 🎉',
          'postType': 'TEXT',
          'isOc': false,
          'isSpoiler': false,
        },
