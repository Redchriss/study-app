    ...
    return Column(
      ...
      children: [
            ...
            Expanded(
              child: ClipRRect(
                ...
                child: LinearProgressIndicator(
                  ...
                  valueColor:
                      const AlwaysStoppedAnimation(KidsVisualTheme.trailGreen),
                ),
              ),
            ),
          ],
        ...
        TextButton.icon(
          ...
          style:
              TextButton.styleFrom(foregroundColor: KidsVisualTheme.inkMuted),
        ),
      ],
    );
  }
          ...
          child: Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color:
                      fg.withValues(alpha: answered && isCorrect ? 0.25 : 0.1),
              ...
              Expanded(
                  child: Text(text,
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.w700,
                          color: fg))),
              if (trailingIcon != null) Icon(trailingIcon, color: fg, size: 22),
            ],
          ),
        ),
      ),
