  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Query(
      ...
      builder: (QueryResult result, {VoidCallback? refetch, FetchMore? fetchMore}) {
        if (result.isLoading) return Scaffold(appBar: AppBar(), body: const Center(child: LoadingWidget()));
        final c = result.data?['community'] as Map<String, dynamic>?;
        if (c == null) return Scaffold(appBar: AppBar(), body: const Center(child: Text('Not found')));
            ...
            children: [
              ...
              if (c['description'] != null && c['description'].toString().isNotEmpty)
                Padding(
                  ...
                  child: Text(c['description'].toString(), style: const TextStyle(height: 1.4)),
                ),
              Row(children: [
                ...
                const SizedBox(width: 16),
                _stat(Icons.lock_outline, c['communityType']?.toString() ?? 'public'),
              ]),
                  ...
                  return Card(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text('${e.key + 1}. ${r['title'] ?? ''}', style: const TextStyle(fontWeight: FontWeight.w600)),
              ...
              const Divider(height: 32),
              Text('Moderators', style: Theme.of(context).textTheme.titleMedium?.copyWith(fontWeight: FontWeight.w800)),
              const SizedBox(height: 8),
              ...mods.map((m) {
                ...
                return Padding(
                  ...
                  child: Row(children: [
                    const Icon(Icons.shield_rounded, size: 16, color: DesignTokens.primary),
