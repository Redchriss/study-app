...
class CirclesScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Study Circles', style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w800)),
        centerTitle: false,
        actions: [
          IconButton(
        ...
        builder: (result, {fetchMore, refetch}) {
              ...
              child: Column(
                ...
                children: [
                  Container(
                    ...
                    child: const Icon(Icons.groups_rounded, size: 64, color: DesignTokens.primary),
                  ),
                  const SizedBox(height: 24),
                  Text('No circles yet', style: theme.textTheme.titleLarge?.copyWith(fontWeight: FontWeight.w800)),
                  const SizedBox(height: 8),
                  Text(
                    'Complete your profile setup to join\nstudy groups matching your level.', 
                    textAlign: TextAlign.center,
                    style: TextStyle(color: DesignTokens.textSecondary, height: 1.4, fontSize: 15),
                  ),
          ...
          return RefreshIndicator(
            ...
            child: ListView.builder(
              padding: const EdgeInsets.fromLTRB(DesignTokens.spLg, DesignTokens.spSm, DesignTokens.spLg, DesignTokens.spXl),
              itemCount: circles.length,
              itemBuilder: (_, i) {
                final c = circles[i];
                final String level = c['educationLevel']?.toString().toLowerCase() ?? '';
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    const SizedBox(width: 8),
                                    Icon(Icons.people_alt_rounded, size: 14, color: DesignTokens.textSecondary),
